...
\textcolor{keyword}{static} \textcolor{keywordtype}{void} sigint\_handler () \{
    printf (\textcolor{stringliteral}{"Exiting... %ld\(\backslash\)n"}, pthread\_self());
    running = 0;
\};
...
\textcolor{keyword}{static} \textcolor{keywordtype}{void} my\_callback (\textcolor{keyword}{struct} \hyperlink{structrb__http__handler__s}{rb\_http\_handler\_s} * rb\_http\_handler,
    ...
    printf (\textcolor{stringliteral}{"STATUS CODE: %d\(\backslash\)n"}, status\_code);

    \textcolor{keywordflow}{if} (status\_code\_str != NULL)
        printf (\textcolor{stringliteral}{"STATUS CODE DESCRIPTION: %s\(\backslash\)n"}, status\_code\_str);
...
\textcolor{keywordtype}{int} \hyperlink{rb__http__handler__example_8c_ae66f6b31b5ad750f1fe042a706a4e3d4}{main}() \{
    ...
    handler = \hyperlink{librb-http_8h_a190d674d1d8cac12e0dd2445c5c8cba4}{rb\_http\_handler} (url, max\_connections, 512, NULL, 0);
    printf (\textcolor{stringliteral}{"This will send 1024 messages\(\backslash\)n"});
    printf (\textcolor{stringliteral}{"Press enter to start sending messages:\(\backslash\)n"});
    ...
    \textcolor{keywordflow}{for} (i = 0 ; i < 1024 && running; i++) \{
        ...
        \textcolor{keywordflow}{while} (\hyperlink{librb-http_8h_a6f4b97a63ef87f1f51176db8947ab907}{rb\_http\_produce} (handler, strdup (\textcolor{keywordtype}{string}), strlen (\textcolor{keywordtype}{string}), 0,
                                NULL) > 0) \{
    ...
    \hyperlink{librb-http_8h_aa9121154f5242572bfbc47fca33c1310}{rb\_http\_get\_reports} (handler, my\_callback);
    \hyperlink{librb-http_8h_a57eb6a7b4fba5c589b2a4afbb61f314c}{rb\_http\_handler\_destroy} (handler);
